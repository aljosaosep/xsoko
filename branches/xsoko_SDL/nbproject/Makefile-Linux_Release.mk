...
# Object Directory
OBJECTDIR=build/Linux_Release/${PLATFORM}
...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Linux_Release.mk dist/Linux_Release/${PLATFORM}/xsoko

dist/Linux_Release/${PLATFORM}/xsoko: ${OBJECTFILES}
	${MKDIR} -p dist/Linux_Release/${PLATFORM}
	${LINK.cc} -o dist/Linux_Release/${PLATFORM}/xsoko ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/src/md2loader/Anorms.h.gch: src/md2loader/Anorms.h 
	${MKDIR} -p ${OBJECTDIR}/src/md2loader
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/md2loader/Anorms.h
...
${OBJECTDIR}/src/camera.o: src/camera.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/camera.o src/camera.cpp

${OBJECTDIR}/src/gui/text.h.gch: src/gui/text.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/text.h

${OBJECTDIR}/src/gui/gui.o: src/gui/gui.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/gui.o src/gui/gui.cpp

${OBJECTDIR}/src/game.o: src/game.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game.o src/game.cpp

${OBJECTDIR}/src/gui/radiobuttongroup.o: src/gui/radiobuttongroup.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/radiobuttongroup.o src/gui/radiobuttongroup.cpp

${OBJECTDIR}/src/session.o: src/session.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/session.o src/session.cpp

${OBJECTDIR}/src/md2loader/md2model.o: src/md2loader/md2model.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/md2loader
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/md2loader/md2model.o src/md2loader/md2model.cpp

${OBJECTDIR}/src/gui/editbox.h.gch: src/gui/editbox.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/editbox.h
...
${OBJECTDIR}/src/gui/commongui.h.gch: src/gui/commongui.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/commongui.h

${OBJECTDIR}/src/resource.o: src/resource.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/resource.o src/resource.cpp

${OBJECTDIR}/src/input.o: src/input.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/input.o src/input.cpp

${OBJECTDIR}/src/main.o: src/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/main.o src/main.cpp

${OBJECTDIR}/src/gui/checkbox.o: src/gui/checkbox.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/checkbox.o src/gui/checkbox.cpp
...
${OBJECTDIR}/src/zip/zipfile.o: src/zip/zipfile.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/zip
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/zip/zipfile.o src/zip/zipfile.cpp

${OBJECTDIR}/src/gui/radiobutton.h.gch: src/gui/radiobutton.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/radiobutton.h

${OBJECTDIR}/src/gui/fonts.o: src/gui/fonts.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/fonts.o src/gui/fonts.cpp

${OBJECTDIR}/src/level.o: src/level.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/level.o src/level.cpp

${OBJECTDIR}/src/gui/button.h.gch: src/gui/button.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/button.h

${OBJECTDIR}/src/gui/panel.h.gch: src/gui/panel.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/panel.h

${OBJECTDIR}/src/vector.o: src/vector.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/vector.o src/vector.cpp

${OBJECTDIR}/src/gui/editbox.o: src/gui/editbox.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/editbox.o src/gui/editbox.cpp

${OBJECTDIR}/src/player.o: src/player.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/player.o src/player.cpp

${OBJECTDIR}/src/object.o: src/object.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/object.o src/object.cpp
...
${OBJECTDIR}/src/gui/text.o: src/gui/text.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/text.o src/gui/text.cpp

${OBJECTDIR}/src/gui/radiobuttongroup.h.gch: src/gui/radiobuttongroup.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/radiobuttongroup.h

${OBJECTDIR}/src/gui/window.h.gch: src/gui/window.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/window.h

${OBJECTDIR}/src/messages.o: src/messages.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/messages.o src/messages.cpp

${OBJECTDIR}/src/game-render.o: src/game-render.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game-render.o src/game-render.cpp

${OBJECTDIR}/src/gui/window.o: src/gui/window.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/window.o src/gui/window.cpp

${OBJECTDIR}/src/core.o: src/core.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/core.o src/core.cpp

${OBJECTDIR}/src/io.o: src/io.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/io.o src/io.cpp

${OBJECTDIR}/src/gui/scrollbar.o: src/gui/scrollbar.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/scrollbar.o src/gui/scrollbar.cpp

${OBJECTDIR}/src/renderer/renderer-texture.o: src/renderer/renderer-texture.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/renderer
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/renderer/renderer-texture.o src/renderer/renderer-texture.cpp

${OBJECTDIR}/src/gui/scrollbar.h.gch: src/gui/scrollbar.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/scrollbar.h

${OBJECTDIR}/src/gui/container.o: src/gui/container.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/container.o src/gui/container.cpp

${OBJECTDIR}/src/gui/container.h.gch: src/gui/container.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/container.h

${OBJECTDIR}/src/gui/button.o: src/gui/button.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/button.o src/gui/button.cpp

${OBJECTDIR}/src/game-init.o: src/game-init.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game-init.o src/game-init.cpp

${OBJECTDIR}/src/gui/listbox.o: src/gui/listbox.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/listbox.o src/gui/listbox.cpp

${OBJECTDIR}/src/gui/checkbox.h.gch: src/gui/checkbox.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/checkbox.h

${OBJECTDIR}/src/gui/component.h.gch: src/gui/component.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/component.h

${OBJECTDIR}/src/gui/listbox.h.gch: src/gui/listbox.h 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o $@ src/gui/listbox.h

${OBJECTDIR}/src/CommonStructures.o: src/CommonStructures.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CommonStructures.o src/CommonStructures.cpp

${OBJECTDIR}/src/renderer/particle.o: src/renderer/particle.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/renderer
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/renderer/particle.o src/renderer/particle.cpp

${OBJECTDIR}/src/levelbox.o: src/levelbox.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/levelbox.o src/levelbox.cpp

${OBJECTDIR}/src/gui/radiobutton.o: src/gui/radiobutton.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gui
	${RM} $@.d
	$(COMPILE.cc) -O2 -DLinux_Release -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/gui/radiobutton.o src/gui/radiobutton.cpp
...
.clean-conf:
	...
	${RM} dist/Linux_Release/${PLATFORM}/xsoko
