...
# Object Directory
OBJECTDIR=build/Linux_Release/Cygwin-Windows
...
# Build Targets
.build-conf: ${BUILD_SUBPROJECTS} dist/Linux_Release/Cygwin-Windows/xsoko.exe

dist/Linux_Release/Cygwin-Windows/xsoko.exe: ${OBJECTFILES}
	${MKDIR} -p dist/Linux_Release/Cygwin-Windows
	${LINK.cc} -o dist/Linux_Release/Cygwin-Windows/xsoko ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf:
	...
	${RM} dist/Linux_Release/Cygwin-Windows/xsoko.exe
